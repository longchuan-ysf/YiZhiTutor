        ...
        admin.open({
            ...
            success: function (layero, dIndex) {
                ...
                form.on('submit(configEditSubmit)', function (data) {
                    ...
                    $.post(mData ? '/config/update' : '/config/add', JSON.stringify(data.field), function (res) {
        ...
        admin.open({
            ...
            success: function (layero, dIndex) {
                ...
                form.on('submit(configDataEditSubmit)', function (data) {
                    ...
                    var loadIndex = layer.load(2);
                    $.post(mData ? '/configdata/update' : '/configdata/add', JSON.stringify(data.field), function (res) {
                        layer.close(loadIndex);
                        if (0 === res.code) {
                            layer.close(dIndex);
                            layer.msg(res.msg, {icon: 1});
