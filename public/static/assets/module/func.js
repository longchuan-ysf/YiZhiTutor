    ...
    var t = {
        974: () => {
            layui.define(["form", "layer", "table", "common", "treeTable"], (function (t) {
                "use strict";
                var e, a, n, i, l, o = layui.form, r = layui.table, c = layui.layer, u = layui.common,
                    d = layui.treeTable, s = layui.$, f = 0, h = 0, m = !1, p = {
                        tableIns: function (t, o, d = null, p = "", b = !1) {
                            ...
                            return e = r.render({
                                ...
                                i.id = a.id, i[n] = e;
                                var l = JSON.stringify(i), o = JSON.parse(l), r = cUrl + "/update";
                                u.ajaxPost(r, o, (function (t, e) {
                                }), "更新中...", "PUT")
                        ...
                        }, ajaxPost: function (t, e, a = null, n = "处理中...", i) {
                            u.ajaxPost(t, e, a, n, i)
                        }, ajaxGet: function (t, e, a = null, n = "处理中...") {
                            u.ajaxGet(t, e, a, n)
                        }, formSwitch: function (t, e = "", a = null, n = "处理中,请稍后...", i = "PUT") {
                ...
                u.verify(), o.on("submit(submitForm)", (function (t) {
                    ...
                    switch (s(this).attr("lay-event")) {
                        case"add":
                            ...
                            break;
                        case"dall":
                            (l = {title: "批量删除"}).url = cUrl + "/delete", l.data = t, l.confirm = !0, l.type = "POST", u.batchFunc(l, (function () {
                                e.reload()
                            }), "DELETE");
                            break;
                        case"batchCache":
                            (l = {title: "批量重置缓存"}).url = cUrl + "/batchCache", l.data = t, l.confirm = !0, l.type = "GET", u.batchFunc(l, (function () {
                                e.reload()
                            }));
                            break;
                        case"batchEnable":
                            (l = {title: "批量启用状态"}).url = cUrl + "/batchStatus", l.param = n, l.data = t, l.form = "submitForm", l.confirm = !0, l.show_tips = "处理中...", l.type = "POST", u.batchFunc(l, (function () {
                                e.reload()
                            }));
                            break;
                        case"batchDisable":
                            (l = {title: "批量禁用状态"}).url = cUrl + "/batchStatus", l.param = n, l.data = t, l.confirm = !0, l.show_tips = "处理中...", l.type = "POST", u.batchFunc(l, (function () {
                                e.reload()
                            }));
                            break;
                        case"export":
                            var n = [], l = s(".layui-form-item [name]").serializeArray();
                            s.each(l, (function () {
                                n.push(this.name + "=" + this.value)
                            })), (l = {title: "导出数据"}).url = cUrl + "/export", l.data = t, l.confirm = !0, l.type = "POST", l.show_tips = "数据准备中...", l.param = n, u.batchFunc(l, (function (t, e) {
