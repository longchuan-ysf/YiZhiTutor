    ...
    var t = {
        177: () => {
            layui.define((function (t) {
                ...
                r.prototype = {
                    ...
                    addData: function (t) {
                        ...
                        for (var t = a.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var r = 0; r < t.length; r++) {
                            var o = t[e], i = t[r];
                            if (null == this.modules[o][i]) for (var n = -2; n <= 2; n++) for (var s = -2; s <= 2; s++) this.modules[o + n][i + s] = -2 == n || 2 == n || -2 == s || 2 == s || 0 == n && 0 == s
                        }
                        ...
                        for (var r = this.errorCorrectLevel << 3 | e, o = a.getBCHTypeInfo(r), i = 0; i < 15; i++) {
                            var n = !t && 1 == (o >> i & 1);
                            i < 6 ? this.modules[i][8] = n : i < 8 ? this.modules[i + 1][8] = n : this.modules[this.moduleCount - 15 + i][8] = n
                        }
                        for (i = 0; i < 15; i++) n = !t && 1 == (o >> i & 1), i < 8 ? this.modules[8][this.moduleCount - i - 1] = n : i < 9 ? this.modules[8][15 - i - 1 + 1] = n : this.modules[8][15 - i - 1] = n;
                        this.modules[this.moduleCount - 8][8] = !t
                    }, mapData: function (t, e) {
                        for (var r = -1, o = this.moduleCount - 1, i = 7, n = 0, s = this.moduleCount - 1; s > 0; s -= 2) for (6 == s && s--; ;) {
                            for (var h = 0; h < 2; h++) if (null == this.modules[o][s - h]) {
                                var l = !1;
                                n < t.length && (l = 1 == (t[n] >>> i & 1)), a.getMask(e, o, s - h) && (l = !l), this.modules[o][s - h] = l, -1 == --i && (n++, i = 7)
                            }
                    ...
                    for (var i = u.getRSBlocks(t, e), n = new f, s = 0; s < r.length; s++) {
                        var h = r[s];
                        n.put(h.mode, 4), n.put(h.getLength(), a.getLengthInBits(h.mode, t)), h.write(n)
                    }
                    var l = 0;
                    for (s = 0; s < i.length; s++) l += i[s].dataCount;
                    ...
                    for (; !(n.getLengthInBits() >= 8 * l || (n.put(o.PAD0, 8), n.getLengthInBits() >= 8 * l));) n.put(o.PAD1, 8);
                    return o.createBytes(n, i)
                }, o.createBytes = function (t, e) {
                    for (var r = 0, o = 0, i = 0, n = new Array(e.length), s = new Array(e.length), h = 0; h < e.length; h++) {
                        var u = e[h].dataCount, f = e[h].totalCount - u;
                        o = Math.max(o, u), i = Math.max(i, f), n[h] = new Array(u);
                        for (var g = 0; g < n[h].length; g++) n[h][g] = 255 & t.buffer[g + r];
                        r += u;
                        var d = a.getErrorCorrectPolynomial(f), c = new l(n[h], d.getLength() - 1).mod(d);
                        for (s[h] = new Array(d.getLength() - 1), g = 0; g < s[h].length; g++) {
                    ...
                    for (g = 0; g < o; g++) for (h = 0; h < e.length; h++) g < n[h].length && (_[v++] = n[h][g]);
                    for (g = 0; g < i; g++) for (h = 0; h < e.length; h++) g < s[h].length && (_[v++] = s[h][g]);
                    return _
                };
                for (var i = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, n = {
                    L: 1,
                    M: 0,
                    Q: 3,
                    H: 2
                ...
                }, h = 0; h < 8; h++) s.EXP_TABLE[h] = 1 << h;
                for (h = 8; h < 256; h++) s.EXP_TABLE[h] = s.EXP_TABLE[h - 4] ^ s.EXP_TABLE[h - 5] ^ s.EXP_TABLE[h - 6] ^ s.EXP_TABLE[h - 8];
                for (h = 0; h < 255; h++) s.LOG_TABLE[s.EXP_TABLE[h]] = h;
                ...
                l.prototype = {
                    ...
                    for (var o = r.length / 3, i = [], n = 0; n < o; n++) for (var a = r[3 * n + 0], s = r[3 * n + 1], h = r[3 * n + 2], l = 0; l < a; l++) i.push(new u(s, h));
                    return i
                ...
                var c = function () {
                    ...
                    p = "svg" === document.documentElement.tagName.toLowerCase() ? c : "undefined" == typeof CanvasRenderingContext2D ? function () {
                        ...
                        return t.prototype.draw = function (t) {
                            ...
                            var l = r.childNodes[0], u = (e.width - l.offsetWidth) / 2,
                        ...
                        var i = function (t, e) {
                            this._bIsPainted = !1, this._android = d(), this._htOption = e, this._elCanvas = document.createElement("canvas"), this._elCanvas.width = e.width, this._elCanvas.height = e.height, t.appendChild(this._elCanvas), this._el = t, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("img"), this._elImage.alt = "Scan me!", this._elImage.style.display = "none", this._el.appendChild(this._elImage), this._bSupportDataURI = null
                        };
                        return i.prototype.draw = function (t) {
                            var e = this._elImage, r = this._oContext, o = this._htOption, i = t.getModuleCount(),
                                n = o.width / i, a = o.height / i, s = Math.round(n), h = Math.round(a);
                ...
                e = function (t, e) {
                    ...
                    "string" == typeof t && (t = document.getElementById(t)), this._htOption.useSVG && (p = c), this._android = d(), this._el = t, this._oQRCode = null, this._oDrawing = new p(this._el, this._htOption), this._htOption.text && this.makeCode(this._htOption.text)
                }, e.prototype.makeCode = function (t) {
                    this._oQRCode = new o(function (t, e) {
                        for (var r = 1, o = function (t) {
                            var e = encodeURI(t).toString().replace(/\%[0-9a-fA-F]{2}/g, "a");
                            return e.length + (e.length != t ? 3 : 0)
                        }(t), i = 0, a = g.length; i <= a; i++) {
                            var s = 0;
                            switch (e) {
                                case n.L:
                                    s = g[i][0];
